// src/components/PrivacyPolicyDialog.tsx
...
type PrivacyPolicyDialogProps = {
  isOpen: boolean;
  onClose: () => void;
  onAgree?: () => void; // 선택: 동의 버튼에서 체크박스까지 켜고 싶을 때 전달
};
...
export function PrivacyPolicyDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      {/* shadcn/Dialog는 오버레이가 기본 제공됩니다. (bg-black/80) */}
      <DialogContent
        className="
        ...
        <div className="space-y-7 leading-relaxed text-[15px]">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                회원가입: 이름, 아이디, 생년월일, 비밀번호, 이메일, 휴대전화, 전화번호
              </li>
              <li>
                상담 신청: 이름, 생년월일, 휴대전화, 주민등록번호, 이메일
              </li>
              <li>가입 신청: 이름, 생년월일, 휴대전화, 이메일</li>
              <li>
                보험료 계산: 이름, 생년월일, 주민등록번호, 휴대전화, 직업, 운전 여부, 이메일
              </li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                회원 관리: 본인 확인, 개인 식별, 불법·부정 이용 방지, 가입 의사 확인, 연령 확인,
                민원 처리 및 고지사항 전달
              </li>
              <li>
                마케팅 및 광고 활용: 보험 설계 및 가입 서비스 제공, 신규 서비스 개발, 이벤트 안내 및
                광고성 정보 전달
              </li>
              <li>
                비회원 대상 서비스 제공: 본인 확인, 민원 처리, 고지사항 전달, 마케팅 활용 등
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">
              회사는 개인정보를 회원의 경우 회원 탈퇴 시까지, 정보 동의 고객의 경우 정보 삭제 요청
              시까지 보유 및 이용합니다.
            </p>
            <p className="mb-2">
              단, 관련 법령에 따라 일정 기간 보존이 필요한 경우에는 다음과 같이 보존합니다.
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
                이름, 생년월일, 성별, 연락처, 직업, 서비스 이용기록 등은 보험 계약 종료 후 5년간 보관
              </li>
          ...
          <section>
            ...
            <p className="mb-2">
              단, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 따라
              제공될 수 있습니다.
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>제공받는 자: 바르게 담다</li>
            ...
            <p className="mt-4 text-gray-700">
              위 내용에 동의하지 않으실 수 있으며, 동의 거부 시 일부 서비스 이용에 제한이 있을 수
              있습니다.
            </p>
          </section>
        </div>
