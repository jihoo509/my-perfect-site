...
export function PhoneConsultationForm({ title, siteId }: PhoneConsultationFormProps) {
  ...
  const resetForm = () => setFormData({ name: '', birthDate: '', gender: '', phoneNumber: '', agreedToTerms: false });
