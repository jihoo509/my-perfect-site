...
export function PhoneConsultationForm({ title }: PhoneConsultationFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (offlineMode || serverStatus === 'offline') {
        ...
        console.log('오프라인 모드 상담 신청 완료:', savedConsultation);
      ...
      if (result.success) {
        // 간소화된 메시지
        alert('✅ 전화 상담 신청이 정상적으로 접수되었습니다!');
        console.log('전화 상담 신청 성공:', result);
      ...
      console.error('전화 상담 신청 중 오류:', error);
  ...
  return (
    <div className="w-full max-w-md relative z-10">
      ...
      >
        {/* 헤더 텍스트 */}
        <div className="text-center space-y-1 mb-4 bg-[rgba(0,0,0,0)]">
        ...
        <div className="space-y-3">
          ...
          <div className="pt-2">
            <Button
              ...
              disabled={!formData.name || !formData.birthDate || !formData.gender || !formData.phoneNumber || !formData.agreedToTerms || isSubmitting}
